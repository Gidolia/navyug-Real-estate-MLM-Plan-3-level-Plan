...
<head>
	...
	<title>Navyug Group || Forgot Password</title>
				...
				<div class="justify-content-center form_container">
					<form>
						<div class="input-group mb-3">
							...
							<input type="text" name="" class="form-control input_user" value="" placeholder="Email/Mobile Number">
						</div>
						
						
							<div class="d-flex justify-content-center mt-3 login_container">
				 	<button type="button" name="button" class="btn login_btn">Send Link</button>
				   </div>
					</form>
				</div>
