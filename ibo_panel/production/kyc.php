...
<?php
                    ...
                    <form class="form-horizontal form-label-left" method="post">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Account Name</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" class="form-control" name="acc_holder_name" required>
                          <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
                      </div>
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Account No.</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Account Type</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
...
<?php } } ?>
   ...
   ////////////////////////////////////////////////////////////////////////////
        ...
        {
            //echo $x;
            $unq=unq_id_generate(15);
            $sqsqqs="SELECT * FROM `kyc_adhar` WHERE `unique_id`='$unq'";
            ...
            echo "123";
            	if (file_exists("adhar_card_img/" .$unq."f.jpg"))
        {
        unlink("adhar_card_img/" .$unq."f.jpg");
          echo $unq."f.jpg" . " already exists. ";
        }
        if (file_exists("adhar_card_img/" .$unq."b.jpg"))
        {
        unlink("adhar_card_img/" .$unq."b.jpg");
          echo $unq."b.jpg" . " already exists. ";
        }
        
        if(move_uploaded_file($_FILES["adharf"]["tmp_name"], "adhar_card_img/".$unq."f.jpg"))
		{
    		if(move_uploaded_file($_FILES["adharb"]["tmp_name"], "adhar_card_img/".$unq."b.jpg"))
    		{
                echo "Stored in: " . "adhar_card_img/".$unq;
                
                $que="INSERT INTO `kyc_adhar` (`ka_id`, `d_id`, `date`, `time`, `adhar_no`, `adhar_front_img`, `adhar_back_img`, `unique_id`, `status`) VALUES (NULL, '$_SESSION[d_id]', '$date', '$time', '$_POST[adhar_no]', '$unq', '$unq', '$unq', 'p');";
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
         if(isset($_POST[bank_submit]))
        {
            ...
            $que1="INSERT INTO `kyc_bank` (`kb_id`, `d_id`, `date`, `time`, `bank_img`, `bank_name`, `bank_acc_no`, `ifsc_code`, `status`, `holder_name`, `branch_name`, `acc_type`) VALUES (NULL, '$_SESSION[d_id]', '$date', '$time', '', '$_POST[bank_name]', '$_POST[acc_no]', '$_POST[ifsc]', 'p', '$_POST[acc_holder_name]', '$_POST[branch_name]', '$_POST[acc_type]');";
            ...
            if(isset($_POST[pan_submit]))
            {
                for($x=0; $x<100; $x++)
                {
                    //echo $x;
                    $unq=unq_id_generate(15);
                    $sqsqqs="SELECT * FROM `kyc_pan` WHERE `pan_img`='$unq'";
                    $qur=$con->query($sqsqqs);
                    if(mysqli_num_rows($qur)==0)
                    {
                        break;
            ...
            echo "123";
            	if (file_exists("pan_card_img/" .$unq.".jpg"))
        {
        unlink("pan_card_img/" .$unq.".jpg");
          echo $unq.".jpg" . " already exists. ";
        }
        if(move_uploaded_file($_FILES["pan"]["tmp_name"], "pan_card_img/".$unq.".jpg"))
		{
            echo "Stored in: " . "pan_card_img/".$fileName;
            $que1="INSERT INTO `kyc_pan` (`kp_id`, `d_id`, `date`, `time`, `pan_no`, `pan_img`, `status`) VALUES (NULL, '$_SESSION[d_id]', '$date', '$time', '$_POST[pan_no]', '$unq', 'p');";
            //$que1="INSERT INTO `kyc_pan` (`kp_id`, `d_id`, `pan_no`, `pan_img`,  `date`, `time`, `status`) VALUES (NULL, '$_SESSION[d_id]', '$_POST[pan_no]', '$unq', '$date', '$time', 'p');";
            if($con->query($que1)==TRUE)
            {
