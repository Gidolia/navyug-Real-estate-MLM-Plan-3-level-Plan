...
<html lang="en">
  <head>
    ...
    <title>Navyug Group || Level 3</title>
  ...
  <body class="nav-md">
    ...
    window.location.assign(`${value}`);
        ...
        <table class="table table-striped table-bordered">
            ...
            ?>
            <tr>
                <td><?php echo $a;?></td><td>NG<?php echo $temp[$x];?></td><td><?php echo $temp1[$x];?></td><td><?php if($temp2[$x]=="y"){ ?> <button type="button" class="btn btn-success">Activate</button> <?php }
