...
<html lang="en">
  <head>
    ...
    <title>Navyug Group || Photos Gallery </title>
        ...
        <div class="right_col" role="main">
            ...
            <div class="card card_border py-2 mb-4 col-md-12">
				...
				<div class="cards__heading" style="text-align:center;" >
                    <h3>Your Add Photos</h3>
                </div>
                    <div class="card-body">
                        <div class="center">
                        <h3>Note:- only accept jpg file,please upload jpg file. </h3>
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Add Imagea </label>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Photos Name</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
...
/////////////////////// end news_name///////////////////////////
 ...
 if(isset($_POST[image_submit]))
        ...
        if(move_uploaded_file($_FILES["add_images"]["tmp_name"], "nios_image/".$tbin.".jpg"))
		{
           ...
           $sbug="INSERT INTO `web_gallery` (`wg_id`, `image`, `date`, `time`, `gallery_type`, `video`, `name`, `note`, `s_notes`, `text_mess`, `ss_note`) VALUES (NULL, '$tbin.jpg', '$date', '$time', '$_POST[select]', '', '$_POST[name]', 'photo Not Published', 'p', '','Gallery P&V');";
           
            if($con->query($sbug)==TRUE)
            {
                echo "<script>alert('add Photos Gallery  Sucessfully');
