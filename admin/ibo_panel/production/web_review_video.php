...
<html lang="en">
  <head>
    ...
    <title>Navyug Group || Your Add Customer Reviews Videos</title>
            ...
            <div class="card card_border py-2 mb-4 col-md-12">
				...
				<div class="cards__heading" style="text-align:center;" >
                    ...
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Reviews Types</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                           <select class="form-control1 form-control" name="select" readonly>
                            <option value="Reviews Videos">Videos</option>
...
/////////////////////// end news_name///////////////////////////
 ...
 if(isset($_POST[video_submit]))
        ...
        if(move_uploaded_file($_FILES["add_images"]["tmp_name"], "nios_image/".$tbin.".mp4"))
		{
           ...
           $sbug="INSERT INTO `web_gallery` (`wg_id`, `image`, `date`, `time`, `gallery_type`, `video`, `name`, `note`, `s_notes`, `text_mess`, `ss_note`) VALUES (NULL, '', '$date', '$time', '$_POST[select]', '$tbin.mp4', '$_POST[name]', 'Reviews Video Not Published', 'Reviews video', '','Reviews T&V');";
           
            if($con->query($sbug)==TRUE)
            {
                echo "<script>alert('add Reviews Videos Messages Sucessfully');
